...
PopulateMe.defaultMarkdownToolbar = [
  "bold", "italic", "link", "|", "preview", "fullscreen", "|", "guide"
];
...
PopulateMe.init_column = function(c) {
  ...
  // Markdown
  $( 'textarea[data-markdown]', c ).each(function() {
    var $this = $(this);
    var easyMDE = new EasyMDE({
      ...
      spellChecker: false,
      status: false,
      toolbar: $this.data('markdown-toolbar') === '' ? PopulateMe.defaultMarkdownToolbar : $this.data('markdown-toolbar').split(' ')
    });
  });
